...
```js
    "enabled_parsers": ["markdown", "multimarkdown"],
```
...
GitHub Flavored Markdown (GFM) is a very popular markdown.

### Offline

By default almost all extensions in the default produce html with a GitHub-ish feel.
...
```js
    /*
        ...
        Critic marks only affects "markdown" (Python Markdown).
    */
